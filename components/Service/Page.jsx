...
const { lang } = React.use(params);// Get lang from URL: /en/page or /ar/page
  ...
  const translations = {
    en: {
      ...
      heroDesc: "At Dermo Saudia  digital Marketing, we're passionate about creating innovative digital solutions that help businesses thrive in the modern world.",
  ...
  },
  {
    ...
    ar: {
      heroTitle: "خدماتنا",
      heroDesc: "في ديرمو السعودية للتسويق الإلكتروني ، نحن شغوفون بابتكار حلول رقمية تساعد الشركات على الازدهار في العصر الحديث.",
