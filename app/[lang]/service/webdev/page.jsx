...
export async function generateMetadata({ params }) {
  ...
  const translations = {
    ...
    ar: {
      title: "خدمات تطوير المواقع | ديرمو السعودية للتسويق الإلكتروني",
      description:
        "ديرمو السعودية للتسويق الإلكتروني تقدم خدمات تطوير مواقع مبتكرة وقابلة للتوسع: التجارة الإلكترونية، أنظمة إدارة المحتوى، المواقع المخصصة، التعلم الإلكتروني، الشبكات الاجتماعية، ومنصات إدارة العملاء.",
      keywords:
        "تطوير مواقع, مواقع التجارة الإلكترونية, تطوير أنظمة إدارة المحتوى, مواقع مخصصة, منصات التعلم الإلكتروني, الشبكات الاجتماعية, منصات CRM, ديرمو السعودية للتسويق الإلكتروني",
    },
  };
