...
const metas = {
  ...
  ar: {
    ...
    description:
      "ارتقِ بعملك مع وصف للتسويق الإلكتروني — خبراء في التسويق الرقمي، إدارة وسائل التواصل الاجتماعي، الحملات الإعلانية، توسع العلامة التجارية على أمازون، وزيادة الظهور العالمي. دعنا نرفع علامتك التجارية معًا.",
    keywords:
      "التسويق الرقمي، نمو العلامة التجارية، إدارة وسائل التواصل، الحملات الإعلانية، التسويق عبر أمازون، التسويق عبر الإنترنت، توسيع الأعمال، وصف للتسويق الإلكتروني",
  },
};
