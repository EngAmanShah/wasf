...
export default async function Home({ params }) {
  ...
  const content = {
    ...
    ar: {
      ...
      heroDescription:
        "وصف للتسويق الإلكتروني هي وكالة إبداعية بقيادة . نحن متخصصون في التسويق الرقمي، تطوير المواقع والتطبيقات، تصميم الهوية البصرية، وحلول تكنولوجيا المعلومات لمساعدة الشركات على النمو وتحقيق تأثير ملموس.",
