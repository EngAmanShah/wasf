export async function generateMetadata({ params }) {
  ...
  const metas = {
    ...
    ar: {
      title: "الأسئلة المتكررة | ديرمو للتسويق الإلكتروني",
      description:
        "اعثر على إجابات لأكثر الأسئلة شيوعًا حول خدمات وحلول ديرمو للتسويق الإلكتروني للبرمجيات.",
    },
  };
...
export default async function FAQs({ params }) {
  ...
  const faqsAr = [
    {
      question: "ما هي ديرمو للتسويق الإلكتروني؟",
      answer:
        "ديرمو للتسويق الإلكتروني هي شركة برمجيات مقرها في السعودية، تساعد الشركات حول العالم في التحول الرقمي وتطوير البرمجيات المخصصة.",
    },
    {
      question: "ما هي خبرة ديرمو للتسويق الإلكتروني؟",
    ...
    <>
      <div className="py-5" style={{ backgroundColor: "#52a9ff" }}>
        <div className="container d-flex flex-column align-items-center text-white">
          ...
          >
            {lang === "ar"
              ? "هنا ستجد إجابات لأكثر الأسئلة شيوعًا حول خدمات ديرمو للتسويق الإلكتروني للبرمجيات. إذا كان لديك أي أسئلة أخرى، لا تتردد في الاتصال بنا."
